...
namespace Masterchef.Mobile.App.Models
{
    public static class RecipeData
    {
        ...
        //            easyGrouping.AddRange(AllRecipes.Where(r => r.Difficulty == Difficulty.Easy));

        //            var mediumGrouping = new RecipeGrouping("Medium", "M");
        //            mediumGrouping.AddRange(AllRecipes.Where(r => r.Difficulty == Difficulty.Medium));

        //            var hardGrouping = new RecipeGrouping("Hard", "H");
        //            hardGrouping.AddRange(AllRecipes.Where(r => r.Difficulty == Difficulty.Hard));
